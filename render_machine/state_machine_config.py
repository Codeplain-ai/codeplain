...
class StateMachineConfig:
    ...
    def get_action_result_triggers_map(self) -> Dict[str, str]:
        ...
        return {
            ...
            AgentRenderFunctionalRequirement.SUCCESSFUL_OUTCOME: triggers.RENDER_FUNCTIONAL_REQUIREMENT,
            ...
            AgentFixUnitTests.SUCCESSFUL_OUTCOME: triggers.MARK_UNIT_TESTS_READY,
            AgentFixUnitTests.TESTS_PASSED_OUTCOME: triggers.MARK_UNIT_TESTS_PASSED,
            ...
            AgentFixConformanceTest.IMPLEMENTATION_CODE_NOT_UPDATED: triggers.MARK_CONFORMANCE_TESTS_READY,
            AgentFixConformanceTest.IMPLEMENTATION_CODE_UPDATED: triggers.MARK_UNIT_TESTS_READY,
