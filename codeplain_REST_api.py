...
class CodeplainAPI:
    ...
    def fix_unittests_issue(
        ...
        recent_implementation_changes: Optional[str] = None,
    ):
    ...
    def consolidate_conformance_test_lessons(
        self,
        frid,
        plain_source_tree,
        linked_resources,
        ...
        conformance_test_journal,
        run_state: RunState,
    ):
        endpoint_url = f"{self.api_url}/consolidate_conformance_test_lessons"
        headers = {"X-API-Key": self.api_key, "Content-Type": "application/json"}
        ...
        payload = {
            ...
            "conformance_test_journal": conformance_test_journal,
        }
