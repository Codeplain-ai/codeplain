...
[1;34mpositional arguments:[0m
  [1;32mfilename[0m              Path to the plain file to render. The directory containing this file has highest precedence for template loading, so you can place custom templates here to override
...
[1;34moptions:[0m
  ...
  [1;36m--full-plain[0m          Full preview ***plain specification before code generation. Use when you want to preview context of all ***plain primitives that are going to be included in order
